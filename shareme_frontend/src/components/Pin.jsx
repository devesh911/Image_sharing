  ...
  return (
    <div className="m-2 ">
      ...
      >
        ...
        {PostHovered && 
        (<div className=" -z-1 bg-black bg-opacity-50 absolute top-0 w-full h-full flex flex-col justify-between p-1 pr-2 pt-2 pb-2  z-50"
        style={{height:'100%'}}
        >
          <div className="flex items-center justify-between z-auto">
          ...
          <div className="flex justify-between items-center gap-2 w-full">
            ...
            {postedBy?._id === user.googleId && (
             <button
             className="bg-white p-2 rounded-full flex items-center justify-center text-dark opacity-75 hover:opacity-100 outline-none hover:shadow-md"
             type="button"
             onClick={(e)=>{
               e.stopPropagation();
               deletePin(_id)
